...
*/
 ...
 [FN1] = LAYOUT_60_ansi( /* FN1 */
    ...
    KC_LBRC , _______, KC_UP,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  KC_RBRC,
    LSFT(KC_LBRC), KC_LEFT, KC_DOWN, KC_RGHT, _______, _______, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______, _______, LSFT(KC_RBRC),
    SC_LSPO ,          KC_VOLU, KC_VOLD, KC_MUTE, _______, _______, _______, _______, _______, _______, _______, SC_RSPC,
