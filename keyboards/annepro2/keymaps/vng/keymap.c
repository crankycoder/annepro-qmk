...
*/
 ...
 [BASE] = LAYOUT_60_ansi( /* Base */
    ...
    KC_LCTL                 , KC_LGUI   , TD(TD_LALT_CTRL_PGUP) , LT(FN1, KC_SPC)   , TD(TD_RALT_CTRL_PGDN), LT(FN1, KC_LEFT), LT(FN2 ,KC_DOWN), RCTL_T(KC_RGHT)
),
  /*
  * Layer FN1
  * ,-----------------------------------------------------------------------------------------.
...
qk_tap_dance_action_t tap_dance_actions[] = {
    [TD_LALT_CTRL_PGUP]   = ACTION_TAP_DANCE_DOUBLE(KC_LALT, LCTL(KC_PGUP)),
    [TD_RALT_CTRL_PGDN] = ACTION_TAP_DANCE_DOUBLE(KC_RALT, LCTL(KC_PGDN))
};
